...
- (IBAction)spotlightToggle:(id)sender
{
    ...
    if(existingSpotlights.count){
        ...
        [MLPSpotlight addSpotlightInView:self.view atPoint:self.spotlightLabel.center withSpotlightStartRadius:50 withSpotlightEndRadius:100];
         //[MLPSpotlight addSpotlightInView:self.view atPoint:self.spot.center];
    }
}
